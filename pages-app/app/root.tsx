...
const NAV_ITEMS = [
  // Dashboard is the landing page (/). AI Hub is the second tab (/ai-hub).
  { path: '/', label: 'Dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  { path: '/ai-hub', label: 'AI Hub', icon: 'M9.663 17h4.673M12 3a6 6 0 016 6c0 2.5-1.4 4.7-3.5 5.7-.3.2-.5.5-.5.9V16a1 1 0 01-1 1h-2a1 1 0 01-1-1v-.4c0-.4-.2-.7-.5-.9C7.4 13.7 6 11.5 6 9a6 6 0 016-6z' },
  // Assets now also includes code Scripts (files + links + scripts in one list).
  // The old /scripts route redirects here.
  { path: '/assets', label: 'Assets', icon: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4' },
  // Events + Announcements merged into one tab. The wrapper lives at
  // both /events and /announcements; the URL determines the default section.
  { path: '/events', label: 'Events & News', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  { path: '/learning', label: 'Learning Hub', icon: 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  // Teams and Org Chart merged into a single tab with three view modes
  // (Teams / Hierarchy / Map). The merged page lives at /org-chart and is
  // also reachable at /teams for backwards compatibility.
  { path: '/org-chart', label: 'Teams & Org', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
];
