...
export default function Index() {
  ...
  const statCards = [
    ...
    { label: 'Code Scripts', icon: '💻', count: metrics.scripts, path: '/assets', gradient: 'linear-gradient(135deg, #0051C3 0%, #003A8C 100%)', subtitle: 'Ready to use' },
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="animate-in" style={{
        ...
        {[
          { label: 'Upload Asset', path: '/assets?action=upload', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' },
          { label: 'Share Script', path: '/assets?action=share', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
